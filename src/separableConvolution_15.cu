...
void setConvolutionKernel_15( float *h_Kernel )
{
...
__global__ void convolutionX_15_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
__global__ void convolutionY_15_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
__global__ void convolutionZ_15_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
void convolutionX_15( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionX_15_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}

void convolutionY_15( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionY_15_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}

void convolutionZ_15( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionZ_15_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}
...
extern "C" int convolve_15( float *image, float *kernelX, float *kernelY, float *kernelZ, int imageW, int imageH, int imageD, int convolveX, int convolveY, int convolveZ, int outofbounds, float outofboundsvalue, int devCUDA )
{
    ...
    if ( convolveX != 0 )
    {
		setConvolutionKernel_15( kernelX );
	    convolutionX_15( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
		in = 1;
    }

    if ( convolveY != 0 )
    {
    	setConvolutionKernel_15( kernelY );

    	if ( in == 0 )
    	{
    		convolutionY_15( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
    		in = 1;
    	}
    	else
    	{
    		convolutionY_15( d_Input, d_Output, imageW, imageH, imageD, outofbounds, outofboundsvalue );
    		in = 0;
    	}
    }
    ...
    if ( convolveZ != 0 )
    {
		setConvolutionKernel_15( kernelZ );

		if ( in == 0 )
		{
			convolutionZ_15( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
			in = 1;
		}
		else
		{
			convolutionZ_15( d_Input, d_Output, imageW, imageH, imageD, outofbounds, outofboundsvalue );
			in = 0;
		}
    }
