...
void setConvolutionKernel_7( float *h_Kernel )
{
...
__global__ void convolutionX_7_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
__global__ void convolutionY_7_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
__global__ void convolutionZ_7_Kernel( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
...
void convolutionX_7( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionX_7_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}

void convolutionY_7( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionY_7_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}

void convolutionZ_7( float *d_Dst, float *d_Src, int imageW, int imageH, int imageD, int outofbounds, float outofboundsvalue )
{
    ...
    convolutionZ_7_Kernel<<<blocks, threads>>>( d_Dst, d_Src, imageW, imageH, imageD, outofbounds, outofboundsvalue );
}
...
extern "C" int convolve_7( float *image, float *kernelX, float *kernelY, float *kernelZ, int imageW, int imageH, int imageD, int convolveX, int convolveY, int convolveZ, int outofbounds, float outofboundsvalue, int devCUDA )
{
    ...
    if ( convolveX != 0 )
    {
		setConvolutionKernel_7( kernelX );
	    convolutionX_7( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
		in = 1;
    }

    if ( convolveY != 0 )
    {
    	setConvolutionKernel_7( kernelY );

    	if ( in == 0 )
    	{
    		convolutionY_7( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
    		in = 1;
    	}
    	else
    	{
    		convolutionY_7( d_Input, d_Output, imageW, imageH, imageD, outofbounds, outofboundsvalue );
    		in = 0;
    	}
    }
    ...
    if ( convolveZ != 0 )
    {
		setConvolutionKernel_7( kernelZ );

		if ( in == 0 )
		{
			convolutionZ_7( d_Output, d_Input, imageW, imageH, imageD, outofbounds, outofboundsvalue );
			in = 1;
		}
		else
		{
			convolutionZ_7( d_Input, d_Output, imageW, imageH, imageD, outofbounds, outofboundsvalue );
			in = 0;
		}
    }
